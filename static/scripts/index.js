...
var myPlan = L.Routing.plan(waypoints, {
  ...
  geocoder: L.Control.Geocoder.nominatim({
    geocodingQueryParams: { countrycodes: "it", viewbox: "9.038150,45.377474,9.291886,45.557363", bounded: 1},
  }),
  addWaypoints: true,
...
var myLanguageSelector = document.getElementById("language-selector");
var geocoders = document.getElementsByClassName("leaflet-routing-geocoders")[0];
var btnRemoveWaypoints = document.getElementsByClassName(
  "leaflet-routing-remove-waypoint"
);
setParent(myLanguageSelector, geocoders);
//setParent(b, geocoders);
